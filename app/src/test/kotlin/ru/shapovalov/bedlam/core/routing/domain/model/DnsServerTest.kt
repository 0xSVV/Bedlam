...
class DnsServerTest {
    ...
    @CsvSource(
        ...
        "Doq, dns.adguard-dns.com, dns.adguard-dns.com:853",
        "Doq, quic://dns.adguard-dns.com, dns.adguard-dns.com:853",
        "Doq, quic://dns.adguard-dns.com:8853, dns.adguard-dns.com:8853",
        "Doq, 9.9.9.9, 9.9.9.9:853",
        "Doq, quic://[2620:fe::fe]:8853, [2620:fe::fe]:8853",
        ...
        "Https, https://dns.quad9.net/, https://dns.quad9.net/dns-query",
        "Https, https://[2620:fe::fe]/, https://[2620:fe::fe]/dns-query",
        "Https, https://dns.quad9.net:8443/dns-query, https://dns.quad9.net:8443/dns-query",
        "Http3, https://dns.quad9.net/, https://dns.quad9.net/dns-query",
    ...
    @CsvSource(
        ...
        "Doq, quic://dns.quad9.net:0, InvalidPort",
        "Doq, quic://, InvalidAddress",
        ...
        "Https, 1.1.1.1:53, PortNotAllowed",
        "Https, [2620:fe::fe]:8443, PortNotAllowed",
        "Http3, dns.quad9.net:443, PortNotAllowed",
